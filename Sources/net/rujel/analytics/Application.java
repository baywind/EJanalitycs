...
public class Application extends UTF8Application {
	...
	public NSMutableArray<JSONObject> queries;
	...
	public File addResponse(String content, String schoolID, String queryID) throws IOException {
		File schoolDir = new File(home,"response" + File.separatorChar + schoolID +
				File.separatorChar);
		if(!schoolDir.exists())
			schoolDir.mkdirs();
		boolean ok = content.startsWith("<?xml");
		...
		if(query != null) {
			...
			if(ok) {
				...
				if(content.length() >= 255)
					bySchool.put(schoolID,content.substring(0,250) + "...");
				else
					bySchool.put(schoolID,content);
			}
